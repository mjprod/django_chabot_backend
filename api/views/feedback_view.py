        ...
        try:
            ...
            try:
                ...
                with ThreadPoolExecutor() as executor:
                    ...
                    if language == "ms-MY" and generation != transformed_data.get(
                        "correct_answer", ""
                    ):
                        ...
                        translations.append(
                            {
                                "language": "ms-MY",
                                "text": transformed_data.get("correct_answer", ""),
                            }
                        )

                    if language == "cn" and generation != transformed_data.get(
                        "correct_answer", ""
                    ):
                    ...
                    if language == "en" and generation != transformed_data.get(
                        "correct_answer", ""
                    ):
                        english_future = executor.submit(
                            translate_and_clean, generation
                        )
